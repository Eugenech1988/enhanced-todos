...
export const FilterDropdown = ({ className }: FilterDropdownProps) => {
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        className="w-full px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focu  focus:ring-offset-2 focus:ring-blue-500 focus:ring-offset-white focus-visible:ring-2 focus-visible:ring-blue-500 capitalize cursor-pointer"
